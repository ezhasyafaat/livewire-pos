...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="sidebar-mini-hidden-b text-center">
                                ...
                                <ul class="list-inline mt-10">
                                    <li class="list-inline-item">
                                        <a class="link-effect text-dual-primary-dark font-size-sm font-w600 text-uppercase" href="{{ Route::currentRouteName() }}">{{ Auth::user()->name }}</a>
                                    </li>
                                </ul>
                            </div>
            ...
            <footer id="page-footer">
                <div class="content py-20 font-size-sm clearfix">
                    <div class="float-right">
                        Crafted with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="https://github.com/ezhasyafaat" target="_blank">{{ __('Ezxx Code') }}</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="https://1.envato.market/95j" target="_blank">{{ config('app.name') }} 1.0</a> &copy; <span class="js-year-copy"></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
        ...
        <!--
            ...
            to handle those dependencies through webpack. Please check out codebase/_js/main/bootstrap.js for more info.
        ...
        <!--
            ...
            webpack is putting everything together at codebase/_js/main/app.js
        -->
